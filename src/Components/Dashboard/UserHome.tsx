    ...
    <>
      <section className="px-4 pt-6">
        <h2 className="text-3xl font-medium mb-4">
          Hi, Welcome
          <span className="text-[#1E69B8] text-4xl">
            {" "}
          ...
          <div className="p-4 bg-white rounded-lg shadow hover:shadow-xl dark:bg-gray-900">
            <div className="flex flex-row items-center">
              ...
              <div className="flex-shrink">
                <a className="flex items-center px-8 py-4 text-gray-400 dark:text-gray-400 ">
                  <span className="inline-block mr-3">
                    <LuShoppingBasket className="text-5xl" />
                  </span>
                </a>
              </div>
            </div>
          ...
          <div className="p-4 bg-white rounded-lg shadow hover:shadow-xl dark:bg-gray-900">
            <div className="flex flex-row items-center">
              ...
              <div className="flex-shrink">
                <a className="flex items-center px-8 py-4 text-gray-400 dark:text-gray-400 ">
                  <span className="inline-block mr-3">
                    <PiUsersThreeFill className="text-5xl" />
                  </span>
                </a>
              </div>
            </div>
          ...
          <div className="p-4 bg-white rounded-md shadow md:p-6 dark:bg-gray-900 ">
            ...
            <div className="px-4 py-3 text-xs font-medium">
              ...
              <div className="flex justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-800">
                <div className="flex ">
                  <span className="inline-flex items-center justify-center w-8 h-8 mr-2 text-teal-600 rounded dark:text-gray-400 dark:bg-gray-700 bg-teal-50">
                    <svg
                ...
                <div className="flex">
                  <button className="mr-2 text-teal-600 dark:text-gray-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
            ...
            <div className="flex flex-wrap mb-6">
              ...
              <div className="flex-grow px-4">
                ...
                <div className="flex pt-2 text-sm border-t dark:border-gray-700">
                  <a className="flex items-center px-4 py-2 text-black no-underline dark:text-gray-400 ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
